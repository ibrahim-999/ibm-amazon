                ...
                <div class="a-spacing-medium a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input
                      ...
                      :placeholder="addresse.streetAddress"
                    />
                    <!-- Street Address 2 -->
                    <input
                      type="text"
                      ...
                      :placeholder="addresse.streetAddress2"
                    />
                  </div>
                  <!-- City -->
                  <div class="a-spacing-top-medium">
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <input
                      ...
                      style="width: 100%;"
                      v-model="phoneNumber"
                      :placeholder="addresse.phoneNumber"
                    />
                  ...
                  <div class="a-spacing-top-medium">
                    ...
                    <textarea
                      ...
                      :placeholder="addresse.deliveryInstructions"
                    ></textarea>
                  </div>
                  <!-- Security code -->
                  <div class="a-spacing-top-medium">
                    ...
                    <input
                      ...
                      :placeholder="addresse.securityCode"
                    />
                  </div>
                  <div class="a-spacing-top-medium">
...
export default {
  async asyncData({ $axios, params }) {
    try {
      let country = $axios.$get("/api/country");
      ...
      return {
        ...
        addresse: addressResponse.addresse
      };
    } catch (error) {
      console.log(error);
    }
