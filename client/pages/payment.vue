  ...
  <main class="listingPage">
    <div class="container">
      ...
      <div class="a-section a-spacing-none a-spacing-top-small">
        <b>Total price: ${{ getCartTotalPriceWithShipping }}</b>
      </div>
        ...
        <div class="a-row text-right a-spacing-top-large">
          <span class="a-button-register">
            <span class="a-button-inner">
              <span class="a-button-text" @click="onPurchase">Pay</span>
            </span>
          </span>
        </div>
        <hr />
...
export default {
  ...
  mounted() {
    this.stripe = Stripe("pk_test_51IVf0KJhUsnRK7YIJd7yAlr6b0Q7SB8Nne3FVJVj48qBBaPy5KkvlAqoQHyvGWJJBt5PFX6fLysbWmalsid9G5h7003c8Ku80Z");
